                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-button-action">
                                ...
                                >
                                  <a href="updateCategory.php?id_cat=<?php echo $se_cat['id_cat'] ?>" class="fa fa-edit"></a>
                                </button>
                                <button
                                  type="button"
                                ...
                                >
                                  <a href="deleteCategory.php?del=<?php echo $se_cat['id_cat'] ?>" onClick="if(confirm('Bạn có chắc chắn muốn xoá')) return true; else return false;" class="fa fa-times"></a>
                                </button>
                              </div>
                            </td>
                          </tr>
