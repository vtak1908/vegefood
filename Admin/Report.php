                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><img width="70px" height="70px" src="upload/<?php echo $se_pro['image'] ?>" alt="<?php echo $se_pro['name_pro'] ?>"></td>
                            ...
                            <td>
                              <div class="form-button-action">
                                  ...
                                  >
                                    <a href="updateProduct.php?id_pro=<?php echo $se_pro['id_pro'] ?>" class="fa fa-edit"></a>
                                  </button>
                                <button
                                  type="button"
                                ...
                                >
                                  <a href="deleteProduct.php?del=<?php echo $se_pro['id_pro'] ?>" onClick="if(confirm('Bạn có chắc chắn muốn xoá')) return true; else return false;" class="fa fa-times"></a>
                                </button>
                              </div>
                            </td>
                          </tr>
