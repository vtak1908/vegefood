                           ...
                           echo $formatted_price . ' ₫'; ?></td>
                            ...
                            <td>
                              <div class="form-button-action">
                                ...
                                >
                                  <a href="orderDetail.php?id=<?php echo $se['id_order'] ?>" class="fas fa-align-justify"></a>
                                </button>
                                <button
                                  type="button"
                                    class="btn btn-link btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#updateRowModal" onclick="setUpdateModal('<?php echo $se['id_order']; ?>')">
